...
static const char *DEFAULT_CONFIG_CONTENT =
    ...
    "preview.width_ratio = 0.40\n"
    "preview.text.max_bytes = 262144\n"
    "preview.image.max_decode_bytes = 33554432\n"
    "preview.image.max_dimension = 4096\n"
    "preview.selection_debounce_ms = 60\n"
    "\n"
    "# Terminal\n"
    ...
    "# %filepath = path of the right-clicked file or folder\n"
    "# %dir = directory containing the right-clicked item (or itself if "
    "folder)\n"
